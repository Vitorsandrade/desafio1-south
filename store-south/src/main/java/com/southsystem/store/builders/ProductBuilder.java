...
import com.southsystem.store.generators.Generators;
...
public class ProductBuilder {
    ...
    public Product buildProduct() {
        ...
        this.id = Generators.returnId();
        this.barCode = Generators.returnCodBar();
        
        return new Product(id, barCode, description, name, category, price,
    			amount, color, material);
    }
